...
const Archive = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < totalImages; i++) {
      ...
      img.className = "archive__img img";
  ...
  return (
    <div className="archive archive-page" suppressHydrationWarning>
      <div
        ref={dragLayerRef}
        id="drag-layer"
        className="archive__drag-layer"
      ></div>

      <div className="archive__container container" ref={containerRef}>
        <div className="archive__gallery gallery" ref={galleryRef}></div>
      </div>
    </div>
  );
};
